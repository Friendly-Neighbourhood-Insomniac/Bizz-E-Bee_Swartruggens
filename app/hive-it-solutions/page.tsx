...
import { Phone, MessageCircle, Star, Monitor, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function HiveITSolutionsPage() {
  const business = {
    name: "Hive IT Solutions",
    tagline: "Tech support that works.",
    rating: 4.7,
    phone: "+27456789123",
    whatsapp: "https://wa.me/27456789123",
    elite: true,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Hive IT Solutions</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Hive IT Solutions is Swartruggens' premier technology support company. We specialize in 
              making technology work for you, not against you. From simple computer repairs to complex 
              business network setups, our certified technicians provide reliable, affordable IT solutions 
              that keep you connected and productive.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">PC, Mac, mobile</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <motion.div variants={fadeUp}>
            ...
            {/* Image Gallery */}
            <div className="mt-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Our Workshop</h3>
              <div className="grid grid-cols-2 gap-4">
                {business.images.map((image, index) => (
                  <div key={index} className="relative h-32 rounded-lg overflow-hidden">
                    <Image
                      src={image}
                      alt={`${business.name} workshop ${index + 1}`}
                      fill
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Tech Problems? We've Got Solutions!</h2>
          <p className="text-gray-600 mb-6">
            Don't let technology slow you down. Contact Hive IT Solutions for expert support and fast repairs.
          </p>
          <div className="flex space-x-4 justify-center">
