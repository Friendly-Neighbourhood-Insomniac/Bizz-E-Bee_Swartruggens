...
import { Phone, MessageCircle, Star, Paintbrush, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function QueenBeePaintingPage() {
  const business = {
    name: "Queen Bee Painting",
    tagline: "Perfect finish every time.",
    rating: 4.9,
    phone: "+27654321987",
    whatsapp: "https://wa.me/27654321987",
    elite: true,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Queen Bee Painting</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Queen Bee Painting is Swartruggens' premier painting contractor with over 22 years of experience. 
              We pride ourselves on delivering flawless finishes that transform spaces and protect your investment. 
              Our team of skilled painters uses only the highest quality materials and proven techniques to ensure 
              lasting beauty and durability.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                <Paintbrush className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Expert Painters</p>
                  <p className="text-sm text-gray-600">22+ years experience</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Shield className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Premium Paints</p>
                  <p className="text-sm text-gray-600">Top quality materials</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Award className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Perfect Finish</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">On-Time Completion</p>
                  <p className="text-sm text-gray-600">Reliable scheduling</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          ...
          <p className="text-gray-600 mb-6">
            Let Queen Bee Painting bring new life to your home or business with our expert painting services.
          </p>
          <div className="flex space-x-4 justify-center">
