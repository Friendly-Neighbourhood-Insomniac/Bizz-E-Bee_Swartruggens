...
import { Phone, MessageCircle, Star, Coffee, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function BeesKneesCafePage() {
  const business = {
    name: "Bee's Knees Café",
    tagline: "Fresh bakes & buzzing vibes.",
    rating: 4.9,
    phone: "+27111222333",
    whatsapp: "https://wa.me/27111222333",
    elite: true,
    images: [
    ...
    services: [
      ...
      "Artisan Coffee & Specialty Drinks",
      "Healthy Breakfast & Lunch Options",
      "Custom Cakes & Event Catering",
      "Free WiFi & Study-Friendly Space"
    ]
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Bee's Knees Café</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Bee's Knees Café is Swartruggens' favorite gathering spot, serving the community for over 8 years. 
              We're passionate about creating a warm, welcoming atmosphere where friends meet, students study, 
              and families enjoy delicious food and exceptional coffee. Everything is made fresh daily using 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Premium beans</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Made on-site</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Award className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Local Ingredients</p>
                  <p className="text-sm text-gray-600">Supporting community</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">6AM - 6PM</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            ...
            {/* Image Gallery */}
            <div className="mt-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Our Café</h3>
              <div className="grid grid-cols-2 gap-4">
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for Great Coffee & Food?</h2>
          <p className="text-gray-600 mb-6">
            Visit Bee's Knees Café for the best coffee and freshest bakes in Swartruggens. We can't wait to serve you!
          </p>
          <div className="flex space-x-4 justify-center">
