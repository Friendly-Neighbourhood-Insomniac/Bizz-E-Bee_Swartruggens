...
import { Phone, MessageCircle, Star, Hammer, Clock, Shield, Award } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function CarpenterBeeWoodworksPage() {
  const business = {
    name: "Carpenter Bee Woodworks",
    tagline: "Custom furniture & repairs.",
    rating: 4.8,
    phone: "+27789456123",
    whatsapp: "https://wa.me/27789456123",
    elite: false,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Carpenter Bee Woodworks</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Carpenter Bee Woodworks brings over 18 years of craftsmanship to Swartruggens. We specialize 
              in creating beautiful, functional wooden pieces that last a lifetime. From custom furniture 
              to kitchen cabinets, our skilled carpenters use traditional techniques combined with modern 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Master Craftsmen</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Premium wood selection</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <motion.div variants={fadeUp}>
            ...
            {/* Image Gallery */}
            <div className="mt-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Our Craftsmanship</h3>
              <div className="grid grid-cols-2 gap-4">
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for Custom Woodwork?</h2>
          <p className="text-gray-600 mb-6">
            Let Carpenter Bee Woodworks create something beautiful and functional for your space. Contact us for a consultation!
          </p>
          <div className="flex space-x-4 justify-center">
