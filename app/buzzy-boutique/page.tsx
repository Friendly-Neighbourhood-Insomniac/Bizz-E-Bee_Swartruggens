...
import { Phone, MessageCircle, Star, ShoppingBag, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function BuzzyBoutiquePage() {
  const business = {
    name: "Buzzy Boutique",
    tagline: "Fashion that makes you buzz!",
    rating: 4.8,
    phone: "+27555444333",
    whatsapp: "https://wa.me/27555444333",
    elite: true,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Buzzy Boutique</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Buzzy Boutique has been Swartruggens' premier fashion destination for over 6 years. 
              We curate the latest trends and timeless pieces to help you express your unique style. 
              Our personal styling consultations ensure you always look and feel your best, whether 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Latest Trends</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">9AM - 6PM</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready to Update Your Style?</h2>
          <p className="text-gray-600 mb-6">
            Visit Buzzy Boutique for the latest fashion trends and personal styling advice. Let us help you look amazing!
          </p>
          <div className="flex space-x-4 justify-center">
