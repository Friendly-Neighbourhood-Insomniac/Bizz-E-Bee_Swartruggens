      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <motion.div variants={fadeUp}>
            <SectionHeader
              title="Trades"
              subtitle="Skilled tradespeople for all your construction and repair needs"
              centered
            />
          </motion.div>

          <motion.div variants={fadeUp}>
            <ListingCarousel category="trades" />
          </motion.div>

          <motion.div variants={fadeUp} className="bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">
              Top Rated Trades Businesses
            </h2>
            <div className="space-y-4">
              {listings
                .filter(listing => listing.category === 'trades')
