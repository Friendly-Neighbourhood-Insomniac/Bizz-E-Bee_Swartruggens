...
export default function HoneycombPlumbingPage() {
  const business = {
    name: "Honeycomb Plumbing",
    tagline: "Fast fixes, fair prices.",
    rating: 4.8,
    phone: "+27123456789",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Honeycomb Plumbing</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              With over 15 years of experience serving Swartruggens, Honeycomb Plumbing is your trusted 
              local plumbing expert. We pride ourselves on fast response times, quality workmanship, and 
              fair pricing. No job is too big or too small - from emergency repairs to complete bathroom renovations.
            </p>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Work warranty</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Need Plumbing Help?</h2>
          <p className="text-gray-600 mb-6">
            Don't let plumbing problems ruin your day. Call Honeycomb Plumbing for fast, reliable service.
          </p>
          <div className="flex space-x-4 justify-center">
