...
import { Phone, MessageCircle, Star, ChefHat, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function HiveSteakhousePage() {
  const business = {
    name: "Hive Steakhouse",
    tagline: "Premium cuts, perfect grills.",
    rating: 4.8,
    phone: "+27666777888",
    whatsapp: "https://wa.me/27666777888",
    elite: true,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Hive Steakhouse</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Hive Steakhouse is Swartruggens' premier fine dining destination, offering the finest cuts of aged beef 
              and fresh seafood for over 10 years. Our master chefs prepare each dish with precision and passion, 
              creating an unforgettable dining experience. Whether celebrating a special occasion or enjoying a 
              business dinner, we provide exceptional service in an elegant atmosphere.
            </p>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Aged beef cuts</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">5PM - 11PM</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            ...
            {/* Image Gallery */}
            <div className="mt-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Our Cuisine</h3>
              <div className="grid grid-cols-2 gap-4">
                {business.images.map((image, index) => (
                  <div key={index} className="relative h-32 rounded-lg overflow-hidden">
                    <Image
                      src={image}
                      alt={`${business.name} dish ${index + 1}`}
                      fill
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for Fine Dining?</h2>
          <p className="text-gray-600 mb-6">
            Experience the finest steaks and exceptional service at Hive Steakhouse. Reserve your table today!
          </p>
          <div className="flex space-x-4 justify-center">
