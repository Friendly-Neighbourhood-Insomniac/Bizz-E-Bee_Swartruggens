...
import { Phone, MessageCircle, Star, Scale, Clock, Shield, Award, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function BuzzLegalServicesPage() {
  const business = {
    name: "Buzz Legal Services",
    tagline: "Legal advice you can trust.",
    rating: 4.5,
    phone: "+27555123456",
    whatsapp: "https://wa.me/27555123456",
    elite: true,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Buzz Legal Services</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Buzz Legal Services provides comprehensive legal solutions to individuals and businesses 
              in Swartruggens and surrounding areas. With over 25 years of combined experience, our 
              qualified attorneys offer personalized legal advice and representation you can trust. 
              We're committed to protecting your interests and achieving the best possible outcomes.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                <Scale className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Qualified Attorneys</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Attorney-client privilege</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Responsive Service</p>
                  <p className="text-sm text-gray-600">Quick consultations</p>
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {business.images.map((image, index) => (
                  <div key={index} className="relative h-32 rounded-lg overflow-hidden">
                    <Image
                      src={image}
                      alt={`${business.name} office ${index + 1}`}
                      fill
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Need Legal Advice?</h2>
          <p className="text-gray-600 mb-6">
            Don't navigate legal matters alone. Contact Buzz Legal Services for expert guidance and representation.
          </p>
          <div className="flex space-x-4 justify-center">
