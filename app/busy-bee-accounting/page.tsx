...
import { Phone, MessageCircle, Star, Calculator, Clock, Shield, Award } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function BusyBeeAccountingPage() {
  const business = {
    name: "Busy Bee Accounting",
    tagline: "Numbers that make sense.",
    rating: 4.9,
    phone: "+27123987654",
    whatsapp: "https://wa.me/27123987654",
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Busy Bee Accounting</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              At Busy Bee Accounting, we make complex financial matters simple and understandable. 
              With over 20 years of experience, we provide comprehensive accounting services to 
              individuals and businesses in Swartruggens. Our goal is to help you achieve financial 
              success through expert guidance and personalized service.
            </p>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Qualified accountant</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Clock className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Timely Service</p>
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Need Financial Guidance?</h2>
          <p className="text-gray-600 mb-6">
            Let Busy Bee Accounting handle your numbers so you can focus on growing your business.
          </p>
          <div className="flex space-x-4 justify-center">
