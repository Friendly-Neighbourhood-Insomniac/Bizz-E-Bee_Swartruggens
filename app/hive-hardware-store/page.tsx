...
import { Phone, MessageCircle, Star, Wrench, Clock, Shield, Award } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function HiveHardwareStorePage() {
  const business = {
    name: "Hive Hardware Store",
    tagline: "Everything for your home projects.",
    rating: 4.5,
    phone: "+27987123456",
    whatsapp: "https://wa.me/27987123456",
    elite: false,
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Hive Hardware Store</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Hive Hardware Store has been serving Swartruggens' DIY enthusiasts and contractors for over 14 years. 
              We stock everything you need for home improvement projects, from basic tools to specialized equipment. 
              Our knowledgeable staff provides expert advice to help you choose the right materials and tools for any job.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                <Wrench className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Complete Selection</p>
                  <p className="text-sm text-gray-600">Tools & materials</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Shield className="text-amber-600" size={24} />
                <div>
                  <p className="font-semibold">Quality Brands</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">7AM - 6PM</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          {/* Services Section */}
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">What We Stock</h2>
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for Your Next Project?</h2>
          <p className="text-gray-600 mb-6">
            Visit Hive Hardware Store for all your tools and materials. Our experts are here to help you succeed!
          </p>
          <div className="flex space-x-4 justify-center">
