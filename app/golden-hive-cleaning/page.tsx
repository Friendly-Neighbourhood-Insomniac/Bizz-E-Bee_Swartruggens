...
import { Phone, MessageCircle, Star, Sparkles, Clock, Shield, Award } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { pageTransition, fadeUp, staggerChildren } from '@/lib/motion';

export default function GoldenHiveCleaningPage() {
  const business = {
    name: "Golden Hive Cleaning",
    tagline: "Spotless spaces, happy faces.",
    rating: 4.6,
    phone: "+27987654321",
    whatsapp: "https://wa.me/27987654321",
    images: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Golden Hive Cleaning</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Golden Hive Cleaning brings sparkle and shine to homes and businesses across Swartruggens. 
              Our dedicated team uses eco-friendly products and proven techniques to deliver exceptional 
              cleaning results. We're committed to creating spotless spaces that make our clients smile.
            </p>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Insured & Bonded</p>
                  <p className="text-sm text-gray-600">Your peace of mind</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your convenience</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div variants={fadeUp} className="mt-12 bg-amber-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for a Spotless Space?</h2>
          <p className="text-gray-600 mb-6">
            Let Golden Hive Cleaning transform your home or office. Contact us for a free quote today!
          </p>
          <div className="flex space-x-4 justify-center">
